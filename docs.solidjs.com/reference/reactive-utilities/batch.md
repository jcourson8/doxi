Title: batch - SolidDocs

URL Source: https://docs.solidjs.com/reference/reactive-utilities/batch
...
[Edit this page](https://github.com/solidjs/solid-docs-next/edit/main/src/routes/reference/reactive-utilities/batch.mdx)
...
[Report an issue with this page](https://github.com/solidjs/solid-docs-next/issues/new?assignees=ladybluenotes&labels=improve+documentation%2Cpending+review&projects=&template=CONTENT.yml&title=[Content]:&subject=/reference/reactive-utilities/batch.mdx)

Previous[← onCleanup](https://docs.solidjs.com/reference/lifecycle/on-cleanup)

Next[catchError →](https://docs.solidjs.com/reference/reactive-utilities/catch-error)

On this page

1.  [Overview](https://docs.solidjs.com/reference/reactive-utilities/batch#_top)

Contribute

1.  [Edit this page](https://github.com/solidjs/solid-docs-next/edit/main/src/routes/reference/reactive-utilities/batch.mdx)
2.  [Report an issue with this page](https://github.com/solidjs/solid-docs-next/issues/new?assignees=ladybluenotes&labels=improve+documentation%2Cpending+review&projects=&template=CONTENT.yml&title=[Content]:&subject=/reference/reactive-utilities/batch.mdx)
