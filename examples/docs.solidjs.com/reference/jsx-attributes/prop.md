Title: prop:* - SolidDocs

URL Source: https://docs.solidjs.com/reference/jsx-attributes/prop
...
[Edit this page](https://github.com/solidjs/solid-docs-next/edit/main/src/routes/reference/jsx-attributes/prop.mdx)
...
[Report an issue with this page](https://github.com/solidjs/solid-docs-next/issues/new?assignees=ladybluenotes&labels=improve+documentation%2Cpending+review&projects=&template=CONTENT.yml&title=[Content]:&subject=/reference/jsx-attributes/prop.mdx)

Previous[← @once](https://docs.solidjs.com/reference/jsx-attributes/once)

Next[ref →](https://docs.solidjs.com/reference/jsx-attributes/ref)

On this page

1.  [Overview](https://docs.solidjs.com/reference/jsx-attributes/prop#_top)

Contribute

1.  [Edit this page](https://github.com/solidjs/solid-docs-next/edit/main/src/routes/reference/jsx-attributes/prop.mdx)
2.  [Report an issue with this page](https://github.com/solidjs/solid-docs-next/issues/new?assignees=ladybluenotes&labels=improve+documentation%2Cpending+review&projects=&template=CONTENT.yml&title=[Content]:&subject=/reference/jsx-attributes/prop.mdx)
