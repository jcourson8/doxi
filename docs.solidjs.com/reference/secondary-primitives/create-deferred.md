Title: createDeferred - SolidDocs

URL Source: https://docs.solidjs.com/reference/secondary-primitives/create-deferred

Markdown Content:
createDeferred - SolidDocs
===============
...
[Edit this page](https://github.com/solidjs/solid-docs-next/edit/main/src/routes/reference/secondary-primitives/create-deferred.mdx)
...
[Options](https://docs.solidjs.com/reference/secondary-primitives/create-deferred#options)
------------------------------------------------------------------------------------------
...
[Report an issue with this page](https://github.com/solidjs/solid-docs-next/issues/new?assignees=ladybluenotes&labels=improve+documentation%2Cpending+review&projects=&template=CONTENT.yml&title=[Content]:&subject=/reference/secondary-primitives/create-deferred.mdx)

Previous[← createComputed](https://docs.solidjs.com/reference/secondary-primitives/create-computed)

Next[createReaction →](https://docs.solidjs.com/reference/secondary-primitives/create-reaction)

On this page

1.  [Overview](https://docs.solidjs.com/reference/secondary-primitives/create-deferred#_top)
2.  [Options](https://docs.solidjs.com/reference/secondary-primitives/create-deferred#options)

Contribute

1.  [Edit this page](https://github.com/solidjs/solid-docs-next/edit/main/src/routes/reference/secondary-primitives/create-deferred.mdx)
2.  [Report an issue with this page](https://github.com/solidjs/solid-docs-next/issues/new?assignees=ladybluenotes&labels=improve+documentation%2Cpending+review&projects=&template=CONTENT.yml&title=[Content]:&subject=/reference/secondary-primitives/create-deferred.mdx)
