Title: hydrate - SolidDocs

URL Source: https://docs.solidjs.com/reference/rendering/hydrate
...
[Edit this page](https://github.com/solidjs/solid-docs-next/edit/main/src/routes/reference/rendering/hydrate.mdx)
...
[Parameters](https://docs.solidjs.com/reference/rendering/hydrate#parameters)
-----------------------------------------------------------------------------
...
[Report an issue with this page](https://github.com/solidjs/solid-docs-next/issues/new?assignees=ladybluenotes&labels=improve+documentation%2Cpending+review&projects=&template=CONTENT.yml&title=[Content]:&subject=/reference/rendering/hydrate.mdx)

Previous[← DEV](https://docs.solidjs.com/reference/rendering/dev)

Next[hydrationScript →](https://docs.solidjs.com/reference/rendering/hydration-script)

On this page

1.  [Overview](https://docs.solidjs.com/reference/rendering/hydrate#_top)
2.  [Parameters](https://docs.solidjs.com/reference/rendering/hydrate#parameters)

Contribute

1.  [Edit this page](https://github.com/solidjs/solid-docs-next/edit/main/src/routes/reference/rendering/hydrate.mdx)
2.  [Report an issue with this page](https://github.com/solidjs/solid-docs-next/issues/new?assignees=ladybluenotes&labels=improve+documentation%2Cpending+review&projects=&template=CONTENT.yml&title=[Content]:&subject=/reference/rendering/hydrate.mdx)
