Title: getOwner - SolidDocs

URL Source: https://docs.solidjs.com/reference/reactive-utilities/get-owner
...
[Edit this page](https://github.com/solidjs/solid-docs-next/edit/main/src/routes/reference/reactive-utilities/get-owner.mdx)
...
[Report an issue with this page](https://github.com/solidjs/solid-docs-next/issues/new?assignees=ladybluenotes&labels=improve+documentation%2Cpending+review&projects=&template=CONTENT.yml&title=[Content]:&subject=/reference/reactive-utilities/get-owner.mdx)

Previous[← from](https://docs.solidjs.com/reference/reactive-utilities/from)

Next[indexArray →](https://docs.solidjs.com/reference/reactive-utilities/index-array)

On this page

1.  [Overview](https://docs.solidjs.com/reference/reactive-utilities/get-owner#_top)

Contribute

1.  [Edit this page](https://github.com/solidjs/solid-docs-next/edit/main/src/routes/reference/reactive-utilities/get-owner.mdx)
2.  [Report an issue with this page](https://github.com/solidjs/solid-docs-next/issues/new?assignees=ladybluenotes&labels=improve+documentation%2Cpending+review&projects=&template=CONTENT.yml&title=[Content]:&subject=/reference/reactive-utilities/get-owner.mdx)
