Title: on:* and oncapture:* - SolidDocs

URL Source: https://docs.solidjs.com/reference/jsx-attributes/on-and-oncapture

Markdown Content:
on:\* and oncapture:\* - SolidDocs
===============
...
[Edit this page](https://github.com/solidjs/solid-docs-next/edit/main/src/routes/reference/jsx-attributes/on-and-oncapture.mdx)
...
[Report an issue with this page](https://github.com/solidjs/solid-docs-next/issues/new?assignees=ladybluenotes&labels=improve+documentation%2Cpending+review&projects=&template=CONTENT.yml&title=[Content]:&subject=/reference/jsx-attributes/on-and-oncapture.mdx)

Previous[← on\*](https://docs.solidjs.com/reference/jsx-attributes/on_)

Next[@once →](https://docs.solidjs.com/reference/jsx-attributes/once)

On this page

1.  [Overview](https://docs.solidjs.com/reference/jsx-attributes/on-and-oncapture#_top)

Contribute

1.  [Edit this page](https://github.com/solidjs/solid-docs-next/edit/main/src/routes/reference/jsx-attributes/on-and-oncapture.mdx)
2.  [Report an issue with this page](https://github.com/solidjs/solid-docs-next/issues/new?assignees=ladybluenotes&labels=improve+documentation%2Cpending+review&projects=&template=CONTENT.yml&title=[Content]:&subject=/reference/jsx-attributes/on-and-oncapture.mdx)
