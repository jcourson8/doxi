Title: mergeProps - SolidDocs

URL Source: https://docs.solidjs.com/reference/reactive-utilities/merge-props

Markdown Content:
mergeProps - SolidDocs
===============
...
[Edit this page](https://github.com/solidjs/solid-docs-next/edit/main/src/routes/reference/reactive-utilities/merge-props.mdx)
...
[Report an issue with this page](https://github.com/solidjs/solid-docs-next/issues/new?assignees=ladybluenotes&labels=improve+documentation%2Cpending+review&projects=&template=CONTENT.yml&title=[Content]:&subject=/reference/reactive-utilities/merge-props.mdx)

Previous[← mapArray](https://docs.solidjs.com/reference/reactive-utilities/map-array)

Next[observable →](https://docs.solidjs.com/reference/reactive-utilities/observable)

On this page

1.  [Overview](https://docs.solidjs.com/reference/reactive-utilities/merge-props#_top)

Contribute

1.  [Edit this page](https://github.com/solidjs/solid-docs-next/edit/main/src/routes/reference/reactive-utilities/merge-props.mdx)
2.  [Report an issue with this page](https://github.com/solidjs/solid-docs-next/issues/new?assignees=ladybluenotes&labels=improve+documentation%2Cpending+review&projects=&template=CONTENT.yml&title=[Content]:&subject=/reference/reactive-utilities/merge-props.mdx)
