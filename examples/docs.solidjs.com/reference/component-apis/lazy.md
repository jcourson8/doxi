Title: lazy - SolidDocs

URL Source: https://docs.solidjs.com/reference/component-apis/lazy
...
[Edit this page](https://github.com/solidjs/solid-docs-next/edit/main/src/routes/reference/component-apis/lazy.mdx)
...
[Report an issue with this page](https://github.com/solidjs/solid-docs-next/issues/new?assignees=ladybluenotes&labels=improve+documentation%2Cpending+review&projects=&template=CONTENT.yml&title=[Content]:&subject=/reference/component-apis/lazy.mdx)

Previous[← createUniqueId](https://docs.solidjs.com/reference/component-apis/create-unique-id)

Next[useContext →](https://docs.solidjs.com/reference/component-apis/use-context)

On this page

1.  [Overview](https://docs.solidjs.com/reference/component-apis/lazy#_top)

Contribute

1.  [Edit this page](https://github.com/solidjs/solid-docs-next/edit/main/src/routes/reference/component-apis/lazy.mdx)
2.  [Report an issue with this page](https://github.com/solidjs/solid-docs-next/issues/new?assignees=ladybluenotes&labels=improve+documentation%2Cpending+review&projects=&template=CONTENT.yml&title=[Content]:&subject=/reference/component-apis/lazy.mdx)
