Title: hydrationScript - SolidDocs

URL Source: https://docs.solidjs.com/reference/rendering/hydration-script

Markdown Content:
hydrationScript - SolidDocs
===============
...
[Edit this page](https://github.com/solidjs/solid-docs-next/edit/main/src/routes/reference/rendering/hydration-script.mdx)
...
[Report an issue with this page](https://github.com/solidjs/solid-docs-next/issues/new?assignees=ladybluenotes&labels=improve+documentation%2Cpending+review&projects=&template=CONTENT.yml&title=[Content]:&subject=/reference/rendering/hydration-script.mdx)

Previous[← hydrate](https://docs.solidjs.com/reference/rendering/hydrate)

Next[isServer →](https://docs.solidjs.com/reference/rendering/is-server)

On this page

1.  [Overview](https://docs.solidjs.com/reference/rendering/hydration-script#_top)

Contribute

1.  [Edit this page](https://github.com/solidjs/solid-docs-next/edit/main/src/routes/reference/rendering/hydration-script.mdx)
2.  [Report an issue with this page](https://github.com/solidjs/solid-docs-next/issues/new?assignees=ladybluenotes&labels=improve+documentation%2Cpending+review&projects=&template=CONTENT.yml&title=[Content]:&subject=/reference/rendering/hydration-script.mdx)
