Title: splitProps - SolidDocs

URL Source: https://docs.solidjs.com/reference/reactive-utilities/split-props
...
[Edit this page](https://github.com/solidjs/solid-docs-next/edit/main/src/routes/reference/reactive-utilities/split-props.mdx)
...
[Report an issue with this page](https://github.com/solidjs/solid-docs-next/issues/new?assignees=ladybluenotes&labels=improve+documentation%2Cpending+review&projects=&template=CONTENT.yml&title=[Content]:&subject=/reference/reactive-utilities/split-props.mdx)

Previous[← runWithOwner](https://docs.solidjs.com/reference/reactive-utilities/run-with-owner)

Next[startTransition →](https://docs.solidjs.com/reference/reactive-utilities/start-transition)

On this page

1.  [Overview](https://docs.solidjs.com/reference/reactive-utilities/split-props#_top)

Contribute

1.  [Edit this page](https://github.com/solidjs/solid-docs-next/edit/main/src/routes/reference/reactive-utilities/split-props.mdx)
2.  [Report an issue with this page](https://github.com/solidjs/solid-docs-next/issues/new?assignees=ladybluenotes&labels=improve+documentation%2Cpending+review&projects=&template=CONTENT.yml&title=[Content]:&subject=/reference/reactive-utilities/split-props.mdx)
