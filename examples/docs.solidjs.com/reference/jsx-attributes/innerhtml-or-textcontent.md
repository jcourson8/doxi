Title: innerHTML or textContent - SolidDocs

URL Source: https://docs.solidjs.com/reference/jsx-attributes/innerhtml-or-textcontent

Markdown Content:
innerHTML or textContent - SolidDocs
===============
...
[Edit this page](https://github.com/solidjs/solid-docs-next/edit/main/src/routes/reference/jsx-attributes/innerhtml-or-textcontent.mdx)
...
[Report an issue with this page](https://github.com/solidjs/solid-docs-next/issues/new?assignees=ladybluenotes&labels=improve+documentation%2Cpending+review&projects=&template=CONTENT.yml&title=[Content]:&subject=/reference/jsx-attributes/innerhtml-or-textcontent.mdx)

Previous[← classList](https://docs.solidjs.com/reference/jsx-attributes/classlist)

Next[on\* →](https://docs.solidjs.com/reference/jsx-attributes/on_)

On this page

1.  [Overview](https://docs.solidjs.com/reference/jsx-attributes/innerhtml-or-textcontent#_top)

Contribute

1.  [Edit this page](https://github.com/solidjs/solid-docs-next/edit/main/src/routes/reference/jsx-attributes/innerhtml-or-textcontent.mdx)
2.  [Report an issue with this page](https://github.com/solidjs/solid-docs-next/issues/new?assignees=ladybluenotes&labels=improve+documentation%2Cpending+review&projects=&template=CONTENT.yml&title=[Content]:&subject=/reference/jsx-attributes/innerhtml-or-textcontent.mdx)
