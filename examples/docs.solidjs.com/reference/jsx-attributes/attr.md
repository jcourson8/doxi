Title: attr:* - SolidDocs

URL Source: https://docs.solidjs.com/reference/jsx-attributes/attr
...
[Edit this page](https://github.com/solidjs/solid-docs-next/edit/main/src/routes/reference/jsx-attributes/attr.mdx)
...
[Report an issue with this page](https://github.com/solidjs/solid-docs-next/issues/new?assignees=ladybluenotes&labels=improve+documentation%2Cpending+review&projects=&template=CONTENT.yml&title=[Content]:&subject=/reference/jsx-attributes/attr.mdx)

Previous[← <SuspenseList\>](https://docs.solidjs.com/reference/components/suspense-list)

Next[classList →](https://docs.solidjs.com/reference/jsx-attributes/classlist)

On this page

1.  [Overview](https://docs.solidjs.com/reference/jsx-attributes/attr#_top)

Contribute

1.  [Edit this page](https://github.com/solidjs/solid-docs-next/edit/main/src/routes/reference/jsx-attributes/attr.mdx)
2.  [Report an issue with this page](https://github.com/solidjs/solid-docs-next/issues/new?assignees=ladybluenotes&labels=improve+documentation%2Cpending+review&projects=&template=CONTENT.yml&title=[Content]:&subject=/reference/jsx-attributes/attr.mdx)
