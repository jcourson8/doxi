Title: catchError - SolidDocs

URL Source: https://docs.solidjs.com/reference/reactive-utilities/catch-error

Markdown Content:
catchError - SolidDocs
===============
...
[Edit this page](https://github.com/solidjs/solid-docs-next/edit/main/src/routes/reference/reactive-utilities/catch-error.mdx)
...
[Report an issue with this page](https://github.com/solidjs/solid-docs-next/issues/new?assignees=ladybluenotes&labels=improve+documentation%2Cpending+review&projects=&template=CONTENT.yml&title=[Content]:&subject=/reference/reactive-utilities/catch-error.mdx)

Previous[← batch](https://docs.solidjs.com/reference/reactive-utilities/batch)

Next[createRoot →](https://docs.solidjs.com/reference/reactive-utilities/create-root)

On this page

1.  [Overview](https://docs.solidjs.com/reference/reactive-utilities/catch-error#_top)

Contribute

1.  [Edit this page](https://github.com/solidjs/solid-docs-next/edit/main/src/routes/reference/reactive-utilities/catch-error.mdx)
2.  [Report an issue with this page](https://github.com/solidjs/solid-docs-next/issues/new?assignees=ladybluenotes&labels=improve+documentation%2Cpending+review&projects=&template=CONTENT.yml&title=[Content]:&subject=/reference/reactive-utilities/catch-error.mdx)
