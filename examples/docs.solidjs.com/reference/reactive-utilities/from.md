Title: from - SolidDocs

URL Source: https://docs.solidjs.com/reference/reactive-utilities/from
...
[Edit this page](https://github.com/solidjs/solid-docs-next/edit/main/src/routes/reference/reactive-utilities/from.mdx)
...
[Arguments](https://docs.solidjs.com/reference/reactive-utilities/from#arguments)
---------------------------------------------------------------------------------
...
[Report an issue with this page](https://github.com/solidjs/solid-docs-next/issues/new?assignees=ladybluenotes&labels=improve+documentation%2Cpending+review&projects=&template=CONTENT.yml&title=[Content]:&subject=/reference/reactive-utilities/from.mdx)

Previous[← createRoot](https://docs.solidjs.com/reference/reactive-utilities/create-root)

Next[getOwner →](https://docs.solidjs.com/reference/reactive-utilities/get-owner)

On this page

1.  [Overview](https://docs.solidjs.com/reference/reactive-utilities/from#_top)

Contribute

1.  [Edit this page](https://github.com/solidjs/solid-docs-next/edit/main/src/routes/reference/reactive-utilities/from.mdx)
2.  [Report an issue with this page](https://github.com/solidjs/solid-docs-next/issues/new?assignees=ladybluenotes&labels=improve+documentation%2Cpending+review&projects=&template=CONTENT.yml&title=[Content]:&subject=/reference/reactive-utilities/from.mdx)
