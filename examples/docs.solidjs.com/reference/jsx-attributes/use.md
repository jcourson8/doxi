...
URL Source: https://docs.solidjs.com/reference/jsx-attributes/use
...
[Edit this page](https://github.com/solidjs/solid-docs-next/edit/main/src/routes/reference/jsx-attributes/use.mdx)
...
function model(el, value) {  const [field, setField] = value()  createRenderEffect(() => (el.value = field()))  el.addEventListener("input", (e) => setField(e.target.value))};
...
[Report an issue with this page](https://github.com/solidjs/solid-docs-next/issues/new?assignees=ladybluenotes&labels=improve+documentation%2Cpending+review&projects=&template=CONTENT.yml&title=[Content]:&subject=/reference/jsx-attributes/use.mdx)

Previous[← style](https://docs.solidjs.com/reference/jsx-attributes/style)

Next[onMount →](https://docs.solidjs.com/reference/lifecycle/on-mount)

On this page

1.  [Overview](https://docs.solidjs.com/reference/jsx-attributes/use#_top)

Contribute

1.  [Edit this page](https://github.com/solidjs/solid-docs-next/edit/main/src/routes/reference/jsx-attributes/use.mdx)
2.  [Report an issue with this page](https://github.com/solidjs/solid-docs-next/issues/new?assignees=ladybluenotes&labels=improve+documentation%2Cpending+review&projects=&template=CONTENT.yml&title=[Content]:&subject=/reference/jsx-attributes/use.mdx)
