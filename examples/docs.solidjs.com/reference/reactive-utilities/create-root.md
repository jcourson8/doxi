Title: createRoot - SolidDocs

URL Source: https://docs.solidjs.com/reference/reactive-utilities/create-root

Markdown Content:
createRoot - SolidDocs
===============
...
[Edit this page](https://github.com/solidjs/solid-docs-next/edit/main/src/routes/reference/reactive-utilities/create-root.mdx)
...
[Report an issue with this page](https://github.com/solidjs/solid-docs-next/issues/new?assignees=ladybluenotes&labels=improve+documentation%2Cpending+review&projects=&template=CONTENT.yml&title=[Content]:&subject=/reference/reactive-utilities/create-root.mdx)

Previous[← catchError](https://docs.solidjs.com/reference/reactive-utilities/catch-error)

Next[from →](https://docs.solidjs.com/reference/reactive-utilities/from)

On this page

1.  [Overview](https://docs.solidjs.com/reference/reactive-utilities/create-root#_top)

Contribute

1.  [Edit this page](https://github.com/solidjs/solid-docs-next/edit/main/src/routes/reference/reactive-utilities/create-root.mdx)
2.  [Report an issue with this page](https://github.com/solidjs/solid-docs-next/issues/new?assignees=ladybluenotes&labels=improve+documentation%2Cpending+review&projects=&template=CONTENT.yml&title=[Content]:&subject=/reference/reactive-utilities/create-root.mdx)
