Title: createSelector - SolidDocs

URL Source: https://docs.solidjs.com/reference/secondary-primitives/create-selector

Markdown Content:
createSelector - SolidDocs
===============
...
[Edit this page](https://github.com/solidjs/solid-docs-next/edit/main/src/routes/reference/secondary-primitives/create-selector.mdx)

```
import { createSelector } from "solid-js"
function createSelector<T, U>(  source: () => T,  fn?: (a: U, b: T) => boolean): (k: U) => boolean
```
...
[Arguments](https://docs.solidjs.com/reference/secondary-primitives/create-selector#arguments)
----------------------------------------------------------------------------------------------
...
The source signal to get the value from.

`fn`

`(a: U, b: T) => boolean`

A function to compare the key and the value.

[Report an issue with this page](https://github.com/solidjs/solid-docs-next/issues/new?assignees=ladybluenotes&labels=improve+documentation%2Cpending+review&projects=&template=CONTENT.yml&title=[Content]:&subject=/reference/secondary-primitives/create-selector.mdx)

Previous[← createRenderEffect](https://docs.solidjs.com/reference/secondary-primitives/create-render-effect)

Next[createMutable →](https://docs.solidjs.com/reference/store-utilities/create-mutable)

On this page

1.  [Overview](https://docs.solidjs.com/reference/secondary-primitives/create-selector#_top)

Contribute

1.  [Edit this page](https://github.com/solidjs/solid-docs-next/edit/main/src/routes/reference/secondary-primitives/create-selector.mdx)
2.  [Report an issue with this page](https://github.com/solidjs/solid-docs-next/issues/new?assignees=ladybluenotes&labels=improve+documentation%2Cpending+review&projects=&template=CONTENT.yml&title=[Content]:&subject=/reference/secondary-primitives/create-selector.mdx)
