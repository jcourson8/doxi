Title: observable - SolidDocs

URL Source: https://docs.solidjs.com/reference/reactive-utilities/observable

Markdown Content:
observable - SolidDocs
===============
...
[Edit this page](https://github.com/solidjs/solid-docs-next/edit/main/src/routes/reference/reactive-utilities/observable.mdx)
...
You can also use `from` without rxjs; check out this [page](https://docs.solidjs.com/reference/reactive-utilities/from).

[Report an issue with this page](https://github.com/solidjs/solid-docs-next/issues/new?assignees=ladybluenotes&labels=improve+documentation%2Cpending+review&projects=&template=CONTENT.yml&title=[Content]:&subject=/reference/reactive-utilities/observable.mdx)

Previous[← mergeProps](https://docs.solidjs.com/reference/reactive-utilities/merge-props)

Next[on →](https://docs.solidjs.com/reference/reactive-utilities/on)

On this page

1.  [Overview](https://docs.solidjs.com/reference/reactive-utilities/observable#_top)

Contribute

1.  [Edit this page](https://github.com/solidjs/solid-docs-next/edit/main/src/routes/reference/reactive-utilities/observable.mdx)
2.  [Report an issue with this page](https://github.com/solidjs/solid-docs-next/issues/new?assignees=ladybluenotes&labels=improve+documentation%2Cpending+review&projects=&template=CONTENT.yml&title=[Content]:&subject=/reference/reactive-utilities/observable.mdx)
