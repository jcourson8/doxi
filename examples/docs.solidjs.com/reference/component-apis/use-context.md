Title: useContext - SolidDocs

URL Source: https://docs.solidjs.com/reference/component-apis/use-context

Markdown Content:
useContext - SolidDocs
===============
...
[Edit this page](https://github.com/solidjs/solid-docs-next/edit/main/src/routes/reference/component-apis/use-context.mdx)

```
import { useContext } from "solid-js"import type { Context } from "solid-js"
...
[Recommended usage](https://docs.solidjs.com/reference/component-apis/use-context#recommended-usage)
----------------------------------------------------------------------------------------------------
...
See the API reference of [createContext](https://docs.solidjs.com/reference/component-apis/create-context) for the explanation of what this solves.

[Report an issue with this page](https://github.com/solidjs/solid-docs-next/issues/new?assignees=ladybluenotes&labels=improve+documentation%2Cpending+review&projects=&template=CONTENT.yml&title=[Content]:&subject=/reference/component-apis/use-context.mdx)

Previous[← lazy](https://docs.solidjs.com/reference/component-apis/lazy)

Next[<Dynamic\> →](https://docs.solidjs.com/reference/components/dynamic)

On this page

1.  [Overview](https://docs.solidjs.com/reference/component-apis/use-context#_top)

Contribute

1.  [Edit this page](https://github.com/solidjs/solid-docs-next/edit/main/src/routes/reference/component-apis/use-context.mdx)
2.  [Report an issue with this page](https://github.com/solidjs/solid-docs-next/issues/new?assignees=ladybluenotes&labels=improve+documentation%2Cpending+review&projects=&template=CONTENT.yml&title=[Content]:&subject=/reference/component-apis/use-context.mdx)
